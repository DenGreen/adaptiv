...
![Layout](readme_img/img/layouts.jpg)

Исходные файлы макетов хранятся в директории [sources](./readme_img/sources/) репозитория:
...
Также папка [sources](./readme_img/sources/) содержит jpg-изображения – превью макетов для быстрого просмотра. **Не верстайте сайт с превью, используйте для верстки psd-макеты.**

В поддиректории [fonts](./readme_img/sources/fonts/) вы можете найти использующиеся в макете шрифты, а в поддиректории [svg](./readme_img/sources/svg/) — иконки в формате `svg`.
...
![Layout](readme_img/img/rotation.jpg)
...
![Layout](readme_img/sources/NOEMI_mq_desktop_popup.jpg)
